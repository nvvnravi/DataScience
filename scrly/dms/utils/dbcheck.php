...
function usage() { /* {{{ */
	...
	echo "\n";
	echo "Description:\n";
	echo "  This program creates an extract of the database containing some fields\n";
	echo "  of all database tables. It does not check the consistency of database tables.\n";
	echo "  Its primary use is for comparing databases after one of them has been moved on\n";
	echo "  a new server or even changed the underlying database technology (e.g. switching.\n";
	echo "  from sqlite to mysql).\n";
	echo "\n";
	echo "Options:\n";
