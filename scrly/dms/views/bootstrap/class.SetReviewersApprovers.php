...
//				print "<input id='appInd".$usr->getID()."' type='hidden' name='indApprovers[]' value='". $usr->getID() ."'>";
			...
			error_log("innoright  -  Here*******approval index check**** = ".isset($approvalIndex["i"][$usr->getID()]["status"]), 0);
...
error_log("innoright  -  Here*********approval index g**********=".$approvalIndex["g"][$group->getID()]["status"], 0);
