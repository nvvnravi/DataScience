...
if ($_POST["approvalType"] == "ind") {
	...
	error_log("innoright  - approvalLogID =   $approvalLogID", 0);
	if(0 > $approvalLogID) {
	...
	error_log("innoright  - approvalType  == grp", 0);
	$comment = $_POST["comment"];
...
if ($_POST["approvalStatus"]==-1){
	error_log("innoright  - approvalStatus", 0);
...
error_log("innoright  - approvalStatus   else  ", 0);
	...
	error_log("innoright  - approvalStatus  $approvalCT     ------  $approvalTotal   ", 0);
	...
	if ($approvalCT == $approvalTotal) {
		error_log("innoright  - approvalCT == approvalTotal  ", 0);
